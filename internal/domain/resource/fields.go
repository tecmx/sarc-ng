...
var SearchableFields = []string{"name", "type", "location"}

var fieldValidator = common.NewFieldValidator(
	"resources",
	[]string{"name", "type", "capacity", "location", "building_id"},
	[]string{"id", "name", "type", "capacity", "location", "building_id", "created_at", "updated_at"},
)
